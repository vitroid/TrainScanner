...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="Make a movie with a thumbnail from a train image")
    ...
    parser.add_argument("--png", "-p", action="store_true", help="中間ファイルをpngにする")
    parser.add_argument("--alternating", "-a", action="store_true", help="前進+後退")
    parser.add_argument("--accel", "-A", action="store_true", help="加速")
