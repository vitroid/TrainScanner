...
![settings](https://github.com/vitroid/TrainScanner/blob/master/images/settings.png?raw=true)

1. ファイルが無事に開くと、大きなダイアログ画面が表示されます。一番上が頭出しのためのスナップショット表示窓、左が列車の歪みを修正するための窓、そして右が動きを検出する枠を指定するための窓です。この順番で作業します。

![edit1](https://github.com/vitroid/TrainScanner/blob/master/images/edit1.png?raw=true)
...
![edit2](https://github.com/vitroid/TrainScanner/blob/master/images/edit2.png?raw=true)
