...
from PyQt4.QtGui     import QImage, QPixmap, QPainter, QWidget, QLabel, QPushButton, QDialog, QApplication, QProgressBar, QVBoxLayout, QScrollArea
from PyQt4.QtCore    import QObject, pyqtSignal, QThread, Qt, QPoint
